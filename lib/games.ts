...
const coreGames: Game[] = [
  ...
  },
  {
    slug: "untrusted",
    title: "Untrusted",
    coverImage: "/covers/untrusted.svg",
    shortDescription: "Meta-JavaScript puzzle adventure where editing code changes the world.",
    description:
      "Untrusted, or The Continuing Adventures of Dr. Eval, is a programming puzzle adventure where every level starts impossible until you edit selected JavaScript to alter the game world. This self-hosted build includes the playable code and sound effects, with the large soundtrack omitted from the portal copy.",
    categories: ["Puzzle", "Adventure"],
    tags: ["Programming", "JavaScript", "Roguelike"],
    featured: false,
    mobile: false,
    license: "CC-BY-NC-SA-3.0 for the game; bundled libraries retain their own licenses",
    sourceUrl: "https://github.com/AlexNisnevich/untrusted",
    attribution: "Alex Nisnevich, Greg Shuflin, and Untrusted contributors",
    embedUrl: "/games/untrusted/index.html",
  },
  {
    slug: "img-shuffle",
    title: "Img Shuffle",
    coverImage: "/covers/img-shuffle.svg",
    shortDescription: "A sliding picture puzzle built from colorful image slices.",
    description:
      "Img Shuffle is a browser puzzle game where photos are sliced into tiles and shuffled into a visual challenge. Pick an official image, choose the difficulty, and rearrange the pieces until the picture is restored.",
    categories: ["Puzzle", "Casual"],
    tags: ["Images", "Sliding Puzzle", "Relaxing"],
    featured: false,
    mobile: true,
    license: "No license file provided in the repository",
    sourceUrl: "https://github.com/viviengaluchot/svelte-kit-img-shuffle",
    attribution: "Vivien Galuchot and contributors",
    embedUrl: "/games/img-shuffle",
  },
  {
    slug: "multistuntcar",
    title: "Multi Stunt Car",
    coverImage: "/covers/multistuntcar.png",
    shortDescription: "Fast retro stunt racing with ramps, loops, jumps, and two-player racing.",
    description:
      "Multi Stunt Car is a browser build of a Stunt Car Racer remake with SDL/OpenGL rendering compiled through Emscripten. Race elevated stunt tracks, survive jumps and crashes, and try the two-player mode where supported.",
    categories: ["Racing", "Arcade"],
    tags: ["Cars", "Stunts", "Retro"],
    featured: false,
    mobile: false,
    license: "No license file provided in the repository",
    sourceUrl: "https://github.com/retro-foundry/multistuntcar",
    attribution: "Retro Foundry, StuntCarRemake, ptitSeb, and contributors",
    embedUrl: "/games/multistuntcar/index.html",
  },
  {
    slug: "dieselroids",
    title: "Dieselroids",
    coverImage: "/covers/dieselroids.png",
    shortDescription: "A pure HTML5 Canvas asteroid shooter with vector graphics and Web Audio.",
    description:
      "Dieselroids is a polished arcade asteroid shooter built in a single HTML5 Canvas page. Fly, shoot, dodge debris, survive waves, and chase a high score with vector visuals and synthesized audio.",
    categories: ["Arcade", "Action"],
    tags: ["Shooter", "Asteroids", "High Score"],
    featured: false,
    mobile: false,
    license: "MIT",
    sourceUrl: "https://github.com/dieselinc/dieselroids",
    attribution: "dieselinc",
    embedUrl: "/games/dieselroids/index.html",
  },
  {
    slug: "musubi",
    title: "Musubi",
    coverImage: "/covers/musubi.png",
    shortDescription: "A retro CRT-style logic puzzle about matching numbered neighbor clues.",
    description:
      "Musubi is a polished logic puzzle game with a retro CRT presentation. Tap circles to fill them, read the neighbor-count clues, and solve each board across training, challenge, and expert modes.",
    categories: ["Puzzle", "Casual"],
    tags: ["Logic", "CRT", "Numbers"],
    featured: false,
    mobile: true,
    license: "MIT",
    sourceUrl: "https://github.com/DNSZLSK/musubi",
    attribution: "DNSZLSK",
    embedUrl: "/games/musubi/index.html",
  },
  {
    slug: "radioguessr",
    title: "RadioGuessr",
    coverImage: "/covers/radioguessr.png",
    shortDescription: "Guess where live radio stations are broadcasting from by listening.",
    description:
      "RadioGuessr is a geography guessing game built around live internet radio. Listen to a stream, place a pin on the 3D globe, use optional hints, and score based on how close your guess is to the station location.",
    categories: ["Puzzle", "Educational"],
    tags: ["Geography", "Radio", "Globe"],
    featured: false,
    mobile: true,
    license: "No license file provided in the repository",
    sourceUrl: "https://github.com/barryspacezero/RadioGuessr",
    attribution: "Sparsh Gupta and RadioGuessr contributors",
    embedUrl: "/games/radioguessr/index.html",
  },
  {
    slug: "freeze-trap",
    title: "Freeze Trap",
    coverImage: "/covers/freeze-trap.png",
    shortDescription: "Draw barriers to trap bouncing balls before time and moves run out.",
    description:
      "Freeze Trap is a canvas arcade puzzle game where you draw lines to split the arena and trap bouncing critters inside smaller spaces. Play the campaign, tune your own custom challenge, or use Pollock mode for a relaxed abstract painting sandbox.",
    categories: ["Puzzle", "Arcade"],
    tags: ["Canvas", "Drawing", "Physics"],
    featured: false,
    mobile: true,
    license: "MIT",
    sourceUrl: "https://github.com/deepanwadhwa/freeze_trap",
    attribution: "deepanwadhwa",
    embedUrl: "/games/freeze-trap/index.html",
  },
  {
    slug: "pong-wars-reloaded",
    title: "Pong Wars Reloaded",
    coverImage: "/covers/pong-wars-reloaded.png",
    shortDescription: "Day and Night battle for territory with rackets, powerups, and AI modes.",
    description:
      "Pong Wars Reloaded expands the original day-versus-night territory battle into a full canvas game with rackets, configurable controls, AI opponents, powerups, domination or timed win conditions, mobile controls, and persistent settings.",
    categories: ["Arcade", "Action"],
    tags: ["Pong", "Territory", "Multiplayer"],
    featured: false,
    mobile: true,
    license: "MIT",
    sourceUrl: "https://github.com/mayerwin/pong-wars-reloaded",
    attribution: "Erwin Mayer, Koen van Gilst, and contributors",
    embedUrl: "/games/pong-wars-reloaded/index.html",
  },
  {
    slug: "javascript-gauntlet",
    title: "JavaScript Gauntlet",
    coverImage: "/covers/javascript-gauntlet.jpg",
    shortDescription: "A single-player HTML5 dungeon crawler inspired by classic Gauntlet.",
    description:
      "JavaScript Gauntlet is a client-side canvas dungeon crawler with four character classes, maze-like levels, monsters, keys, potions, treasure, and projectile combat. This portal copy omits the bundled music and sound effects because the upstream README says those audio assets were licensed for that project only.",
    categories: ["Adventure", "Action"],
    tags: ["Dungeon", "Retro", "Canvas"],
    featured: false,
    mobile: false,
    license: "MIT for code; bundled visual assets retain their original upstream attributions",
    sourceUrl: "https://github.com/jakesgordon/javascript-gauntlet",
    attribution: "Jake Gordon and contributors",
    embedUrl: "/games/javascript-gauntlet/index.html",
  },
  {
    slug: "mini-counter-strike",
    title: "Mini Counter Strike",
    coverImage: "/covers/mini-counter-strike.svg",
    shortDescription: "A procedural browser FPS inspired by Counter-Strike.",
    description:
      "Mini Counter Strike is a browser-based FPS with procedural Three.js visuals, Web Audio sound, round-based play, bots, multiple maps, weapons, buy menus, survival and deathmatch modes, mobile controls, and local progress tracking.",
    categories: ["Action", "Shooter"],
    tags: ["FPS", "Three.js", "Bots"],
    featured: false,
    mobile: true,
    license: "No license file provided in the repository",
    sourceUrl: "https://github.com/peterjst/mini-cs",
    attribution: "peterjst",
    embedUrl: "/games/mini-counter-strike/index.html",
  },
];
